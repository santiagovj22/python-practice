...
*/
CREATE OR REPLACE FUNCTION asset_online(_assets uuid[], _time_bucket INTERVAL, _ts_min TIMESTAMP WITHOUT TIME ZONE, _ts_max TIMESTAMP WITHOUT TIME ZONE)
RETURNS TABLE
(
    asset_id uuid,
...
*/
CREATE OR REPLACE FUNCTION asset_offline(_assets uuid[], _time_bucket INTERVAL, _ts_min TIMESTAMP WITHOUT TIME ZONE, _ts_max TIMESTAMP WITHOUT TIME ZONE)
RETURNS TABLE
(
    asset_id uuid,  
